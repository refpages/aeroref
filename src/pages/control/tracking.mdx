...
This page treats reference tracking in a relatively **general** (and therefore more complicated) setting; for a simpler SISO constant-reference tracking summary, see [Step response specifications](step_response_specifications.mdx).
