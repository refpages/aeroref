...
This page treats reference tracking in a relatively **general** (and therefore more complicated) setting; for a simpler SISO constant-reference tracking summary, see [Step response specifications](/control/step_response_specifications).
...
<Result title="Reference tracking with full state feedback">
...
<Result title="Reference tracking with partial state feedback">
...
<Result title="Choosing the desired state in the case of full state feedback">
...
<Result title="Choosing the desired state in the case of partial state feedback">
